...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Pinjaman</div>
            <div class="ps-3">
		...
		<div class="col" style="display: flex; justify-content:space-between">	
			<h6 class="mb-0 text-uppercase">Data Pinjaman</h6>
				<a href="/tambah-pinjaman" class="btn btn-primary radius-2 mb-0"><i class="bx bxs-plus-square"></i>Tambahkan Data</a>
			</div>
			<hr/>
        {{-- end breadcump --}}
					...
					<div class="col">
						<div class="card radius-10 overflow-hidden">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0">Tenggat Bayar</p>
										<h5 class="mb-0">2023/10/30</h5>
									</div>
