...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Tambah Data Simpanan</div>
            <div class="ps-3">
        ...
        <div class="col" style="display: flex; justify-content:space-between">	
            <h6 class="mb-0 text-uppercase">Isi dengan lengkap</h6>
                <a href="/simpanan" class="btn btn-primary radius-2 mb-0"><i class="bx bx-reply"></i>Kembali</a>
            </div>
            <hr/>
                ...
                <div class="p-4 border rounded">
                    <form class="row g-3 needs-validation" novalidate>
                        <div class="col-md-15">
                            ...
                            <br>
                        <div class="col-md-7">
                            <label for="validationCustom02" class="form-label">Jenis Simpanan</label>
                            ...
                            <label for="validationCustom02" class="form-label">Jumlah Simpanan</label>
